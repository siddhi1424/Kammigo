    ...
    <div className=" mt-32 bg-gray-50 py-20">
      <div className="">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 px-10">
          {/**step 1 */}
          <div className="bg-white  p-8 rounded-2xl shadow-xl flex flex-col items-center mb-4 ">
            <div className="w-16 h-16 rounded-full bg-cyan-400 flex items-center justify-center hover:shadow-xl transition duration-300 text-center font-bold text-xl">
              1
            </div>
