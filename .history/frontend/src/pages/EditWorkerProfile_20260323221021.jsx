...
const ProfilePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-100 to-white-400 flex justify-center items-start py-20 ">
      {/* MAIN CARD */}
      <div className="w-full max-w-sm  mx-auto bg-white rounded-xl shadow-lg p-6">
        {/* 🔥 HEADER (LinkedIn style) */}
        <div className="flex items-center gap-6">
          <img
            src={user.profilepic}
            className="w-20 h-20 md:w-28 md:h-28 lg:w-32 lg:h-32 rounded-full border-4 border-cyan-400 object-cover"
          />
