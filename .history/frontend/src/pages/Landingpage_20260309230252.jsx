...
import HowItworkssection from "../LandingpageComponent/HowItworkssection";
import Servicesection from "../LandingpageComponent/Servicesection";
import WhyChoose from "../LandingpageComponent/WhyChoose";
import Customerworker from "../LandingpageComponent/Customerworker";
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20 w-full">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-20">
            ...
            <div className="max-w-2xl text-center lg:text-left">
              <h1 className="text-cyan-700 text-5xl md:text-7xl lg:text-8xl font-bold mt-20">
                Kammigo
              </h1>
