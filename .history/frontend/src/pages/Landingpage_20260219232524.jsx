  ...
  return (
    <div className="flex items-center justify-between  min-h-screen px-10 py-28  ">
      ...
      <div className="flex items-center justify-center">
        <div className="w-72 h-72 bg-gray-100 shadow-lg flex items-center overflow-hidden relative">
          <img
            src={images[currentIndex]}
            alt="plumber"
            className="w-full h-full object-cover transition-opacity duration-700 ease-in-out"
          />
          <img src={images[currentIndex]} alt="electrician" />
          <img src={images[currentIndex]} alt="cook" />
        </div>
      </div>
    </div>
  );
