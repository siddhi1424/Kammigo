  ...
  return (
    <div className="bg-gray-50 p-8">
      ...
      <div className="max-w-7xl mx-auto px-6 mb-8">
        ...
        <p className="text-gray-600 mt-4 max-w-2xl mx-auto text-left">
      ...
      <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-10">
        <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-xl transition duration-300 text-center bg-transparent bg-black/5">
