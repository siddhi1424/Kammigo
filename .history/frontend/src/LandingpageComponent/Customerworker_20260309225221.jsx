...
// naviagte to login or regiter or dashboard
...
const Customerworker = () => {
  ...
  const handleCustomerclick = () => {
    ...
    if (!token) {
      ...
      navigate("/login");
      alert("You dont have an customer account please login");
    }
  };
  const handleWorkerClick = () => {
    ...
    if (!token) {
      ...
      navigate("/login");
      alert("you dont have an account as worker please login or signin");
    }
  };
      ...
      <div className="grid grid-cols-1 md:grid-cols-2  gap-10 p-8 ">
        ...
        <div className="bg-gray-50 p-10 rounded-2xl shadow-md flex flex-col">
          ...
          <button
            ...
            className="mt-auto bg-gradient-to-tr from-cyan-500 to-cyan-700 hover:shadow-xl mt-6  text-white p-2 rounded-xl transition duration-300"
          >
            Find a Helper
          </button>
        </div>
        ...
        <div className="bg-gray-50 p-10 rounded-2xl shadow-md flex flex-col">
          ...
          <button
            ...
            className="mb-auto bg-gradient-to-tr from-cyan-500 to-cyan-700 hover:shadow-xl mt-4 text-white p-2 rounded-xl transition duration-300"
          >
            Find work
          </button>
        </div>
