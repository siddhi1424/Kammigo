    ...
    <div>
      ...
      <div className="grid grid-cols-2 gap-10 p-8 ">
        ...
        <div className="bg-gray-50 p-10 rounded-2xl shadow-md flex flex-col">
          ...
          <button className="mt-auto mb-auto bg-gradient-to-tr from-cyan-500 to-cyan-700 hover:shadow-xl mt-6  text-white p-2 rounded-xl">
            Find a Helper
          </button>
        </div>
        ...
        <div className="bg-gray-50 p-10 rounded-2xl shadow-md flex flex-col">
          ...
          <button className="bg-gradient-to-tr from-cyan-500 to-cyan-700 hover:shadow-xl mt-4 text-white p-2 rounded-xl">
            Find work
          </button>
        </div>
      </div>
